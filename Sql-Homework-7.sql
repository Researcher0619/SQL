...
-- When we group the films in the film table according to the replacement_cost column, sort the replacement_cost value and the corresponding number of films with more than 50 films.
